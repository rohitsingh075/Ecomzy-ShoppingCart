...
const Cart = () => {
  ...
  const [totalAmount, setTotalAmount] = useState(0);
    const rupeeAmount=(85.17*totalAmount).toFixed(0);
    ...
    <div >
      {cart.length > 0 ? (
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
          ...
          <div className="w-[100%] md:w-[40%] mt-5  flex flex-col border-5  border-green-400 rounded-2xl mb-[2px]">
            ...
            <div className="flex  bottom-1 fixed justify-center items-center gap-x-10">
              <p className="text-xl font-bold"><span className="text-gray-700 font-semibold">Total Amount:</span><span className="">{rupeeAmount}</span></p>
